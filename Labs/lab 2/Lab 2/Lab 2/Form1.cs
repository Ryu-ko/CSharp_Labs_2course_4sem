...
namespace Lab_2
{
    public partial class Library : Form
    {
        ...
        //
        private void textBoxUDC_Validating( object sender, System.ComponentModel.CancelEventArgs e )
        {
            if (!int.TryParse(textBoxUDC.Text, out _))
            {
                errorProviderApp.SetError(textBoxUDC, "Pages should contain a number!");

                e.Cancel = true;
                textBoxUDC.Select(0, textBoxUDC.Text.Length);
            }
            else if (Convert.ToInt32(textBoxUDC.Text) <= 0 || Convert.ToInt32(textBoxUDC.Text) >= 100000)
            {
                errorProviderApp.SetError(textBoxUDC, "Pages should be more than 0");
        ...
        private void textBoxPages_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            else if (Convert.ToInt32(textBoxPages.Text)<=0 || Convert.ToInt32(textBoxPages.Text) >= 100000)
            {
                errorProviderApp.SetError(textBoxPages, "Pages should be more than 0");
